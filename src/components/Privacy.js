...
const Privacy = () => {
  return (
    <React.Fragment>
      <Helmet>
        <title>Spont Store | Privacy</title>
        <style>
          {`
        :root {
          --blue: #007bff;
...
`}
      ...
      <div className="container">
        ...
        <div>
          ...
          limited circumstances: (a) When it is requested or required by law or
          by any court or governmental agency or authority to disclose, for the
