...
const TwoColumn = tw.div`flex flex-col md:flex-row justify-between max-w-screen-xl mx-auto py-5 md:py-20 items-center`;
...
const PrimaryButton = styled(PrimaryButtonBase)((props) => [
  tw`mt-1 md:mt-8 text-sm inline-block mx-auto md:mx-0`,
